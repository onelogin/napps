...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    [[OneLogin SDK] handleURL:url success:^(NSString *token) {
        NSLog(@"%@", token);
        [[[UIAlertView alloc] initWithTitle:@"Secondary Token" message:[NSString stringWithFormat:@"Successfully retrieved Secondary Token:\n%@", token] delegate:nil cancelButtonTitle:@"Yujuh!" otherButtonTitles:nil, nil] show];
